...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2106.072061240433; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1107.4540709424937; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3133.793828249389; // x position of the perpendicular encoder (in tick units)
    }
